...
describe('Enum', function()
    ...
    it('throws an error if one of its members is an invalid identifier', function()
        assert.has_error(function() e.Enum { 'd-e' } end)
        assert.has_error(function() e.Enum { '4d' } end)
        assert.has_error(function() e.Enum { '!@#$%^&*' } end)
        assert.has_error(function() e.Enum { 'smth()' } end)
        assert.has_error(function() e.Enum { '"' } end)
        assert.has_error(function() e.Enum { '' } end)
...
describe('Flags', function()
    ...
    it('throws an error if one of its members is an invalid identifier', function()
        assert.has_error(function() e.Flags { 'd-e' } end)
        assert.has_error(function() e.Flags { '4d' } end)
        assert.has_error(function() e.Flags { '!@#$%^&*' } end)
        assert.has_error(function() e.Flags { 'smth()' } end)
        assert.has_error(function() e.Flags { '"' } end)
        assert.has_error(function() e.Flags { '' } end)
